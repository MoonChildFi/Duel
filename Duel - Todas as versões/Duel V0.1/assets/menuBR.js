...
function account() {
    ...
    if (!skipaccount) {
        ...
        console.log ("===========================================================================")
            ...
            console.log("[03] Voltar para as configurações")
            console.log ("===========================================================================")
            Login = Number(prompt("> "));
        ...
        console.log ("")
                    console.log ("===========================================================================")
                    console.log("[HÁ UM ARQUIVO DE SAVE, DESEJA SOBRESCREVÊ-LO]");
                    console.log ("===========================================================================")
                    console.log ("[S] Sim");
                    console.log ("[N] Não");
...
console.log ("")
        console.log ("===========================================================================")
        console.log("[ERRO 444] IDIOMA INVÁLIDO");
        console.log ("===========================================================================")
...
console.log ("[05] - Incluir Easter Eggs")
...
console.log ("")
        console.log ("===========================================================================")
    console.log ("[ARQUIVO DE FINAIS NÃO ENCONTRADO]")
    check = true
    pausarParaContinuar()
    }
    if (count1 && !FN) {
...
console.log ("")
        ...
        fs.writeFileSync('../assets/ET.txt', 'Easter Eggs Ativados', 'utf8');
...
    console.log ("\x1b[38;5;208m██████████    ████      ██  ████████████  ████              ███\x1b[38;5;208m");
    console.log ("\x1b[38;5;208m████      ██  ████      ██  ████          ████              ████\x1b[38;5;208m");
    console.log ("\x1b[38;5;208m████      ██  ████      ██  ████          ████              ████\x1b[38;5;208m");
    console.log ("\x1b[38;5;208m████      ██  ████      ██  ████          ████              ████\x1b[38;5;208m");
    console.log ("\x1b[38;5;208m████      ██  ████      ██  █████████     ████              ████\x1b[38;5;208m");
...
    console.log ("\x1b[38;5;208m██████████    ████████████  ████████████  ████████████      ████\x1b[38;5;208m");
    console.log ("\x1b[38;5;208m===========================================================================\x1b[38;5;208m")
    console.log ("\x1b[38;5;208m--- FEITO PELA SBG (SAD BERRY GAMES) ---\x1b[38;5;208m")
    console.log ("\x1b[38;5;208m===========================================================================\x1b[38;5;208m")

    // Itera sobre os itens do menu e exibe o selecionado com "> <".
    menuItems.forEach((item, index) => {
        if (index === selectedIndex) {
            console.log(`\x1b[38;5;208m[> ${item} <] \x1b[38;5;208m`);
        } else {
            console.log(`  ${item}`);
        }
    });
...
console.log ("")
    ...
    console.log ("===========================================================================")
    console.log ("-> Você não selecionou um idioma! a versão iniciada será em Português.")
    console.log ("-> Para mudar isso, Siga os passos abaixo")
...
            } else if (selectedIndex === 6) { // Opção "Sair"
                rl.close();
                process.exit(); // Sai do processo Node.js.
            } else if (selectedIndex === 1) { // Opção "Resetar progresso"
...
                    if (error) {
                        console.log("===========================================================================");
                        console.error(`[ERRO: FALHA NO ARQUIVO ${error.message}]`);
...
                process.stdin.pause();
                conquistas();
            } else if (selectedIndex === 4) { // Opção "Créditos"
                process.stdin.setRawMode(false);
                process.stdin.pause();
console.log ("███████████████████████████████████████████████████████████████████")
console.log ("██                                                               ██")
...
console.log ("")
                ...
                console.log ("===========================================================================")
                console.log ("-> Programação: Lucas Eduardo")
                console.log ("-> Testadores Beta: Lucas Eduardo")
                console.log ("-> Roteiro: Miguel Marconato")
                console.log ("-> Artes: Lucas Eduardo")
                console.log ("-> Música: Em breve")
                console.log ("===========================================================================")
...
console.log ("")
                console.log ("===========================================================================")
                console.log ("[APOIE O JOGO]")
                console.log ("===========================================================================")
                console.log ("-> Se você quer apoiar o desenvolvimento do jogo, você pode fazer uma doação,")
                console.log ("qualquer valor é bem vindo e ajuda muito no desenvolvimento do jogo!")
                console.log ("-> Você também pode deixar uma avaliação na página do jogo!")
                console.log ("===========================================================================")
                console.log ("-> Link para a doação: https://sadberry.itch.io/duel")
                console.log ("===========================================================================")
                console.log ("[ABRIR?]")
                console.log ("===========================================================================")
                console.log ("[01] Sim")
                console.log ("[02] Não")
                console.log ("===========================================================================")
                let suporte = Number(prompt("> "))
                if (suporte == 1) {
                    console.clear()
                    console.log ("===========================================================================")
                    console.log ("[ABRINDO O LINK NO NAVEGADOR PADRÃO...]")
                    
                    exec('start https://sadberry.itch.io/duel')
                } else if (suporte == 2) {
                    console.clear()
                    console.log ("===========================================================================")
                    console.log ("[OPÇÃO RECUSADA]")
